...
class TextStyles {
  ...
  static TextStyle get h1 => roboto.copyWith(
      fontWeight: FontWeight.w500, fontSize: FontSizes.s36, height: 1.17);
  static TextStyle get h2 => roboto.copyWith(
      fontWeight: FontWeight.w500, fontSize: FontSizes.s24, height: 1.17);
  static TextStyle get h3 => roboto.copyWith(
      fontWeight: FontWeight.w500, fontSize: FontSizes.s18, height: 1.17);
  static TextStyle get h4 => roboto.copyWith(
      fontWeight: FontWeight.w500, fontSize: FontSizes.s16, height: 1.17);
  static TextStyle get h5 => roboto.copyWith(
      fontWeight: FontWeight.w500, fontSize: FontSizes.s14, height: 1.17);
  static TextStyle get h6 => roboto.copyWith(
      fontWeight: FontWeight.w500, fontSize: FontSizes.s12, height: 1.17);
  static TextStyle get body10 => roboto.copyWith(
      fontWeight: FontWeight.w400, fontSize: FontSizes.s10, height: 1.17);
  static TextStyle get body12 => roboto.copyWith(
      fontWeight: FontWeight.w400, fontSize: FontSizes.s12, height: 1.17);
  static TextStyle get body14 => roboto.copyWith(
      fontWeight: FontWeight.w400, fontSize: FontSizes.s14, height: 1.17);
  static TextStyle get body16 => roboto.copyWith(
      fontWeight: FontWeight.w400, fontSize: FontSizes.s16, height: 1.17);
  static TextStyle get body18 => roboto.copyWith(
      fontWeight: FontWeight.w400, fontSize: FontSizes.s18, height: 1.17);
}
